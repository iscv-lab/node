...
export interface ListBusinessApplyInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'add', values: [BusinessApplyStruct]): string;
...
export type RemoveEvent = TypedEvent<[BusinessApplyStructOutput], RemoveEventObject>;
...
export interface ListBusinessApply extends BaseContract {
  ...
  functions: {
    ...
    at(index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BusinessApplyStructOutput]>;
  ...
  estimateGas: {
    add(item: BusinessApplyStruct, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>;
