...
import type { ListIIGSWResult, ListIIGSWResultInterface } from '../../../../database/business/igg/ListIIGSWResult';
...
type ListIIGSWResultConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: ListIIGSWResultConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class ListIIGSWResult__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ListIIGSWResult> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): ListIIGSWResult {
