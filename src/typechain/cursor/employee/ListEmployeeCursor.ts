...
export interface ListEmployeeCursorInterface extends utils.Interface {
  functions: {
    '_checkExistEmployeeAccount()': FunctionFragment;
  };

  getFunction(nameOrSignatureOrTopic: '_checkExistEmployeeAccount'): FunctionFragment;
...
export interface ListEmployeeCursor extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ListEmployeeCursorInterface;
