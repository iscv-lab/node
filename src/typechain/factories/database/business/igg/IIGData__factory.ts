...
import type { IIGData, IIGDataInterface } from '../../../../database/business/igg/IIGData';
...
type IIGDataConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: IIGDataConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class IIGData__factory extends ContractFactory {
  ...
  override deploy(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<IIGData> {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IIGData {
