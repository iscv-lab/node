...
export type ProfileStructOutput = [BigNumber, string, string, string, string, string, string, string, string] & {
  id: BigNumber;
  user: string;
  name: string;
  phone: string;
...
export interface ListEmployee extends BaseContract {
  ...
  functions: {
    ...
    list(
      ...
      [BigNumber, string, string, string, string, string, string, string, string] & {
        id: BigNumber;
        user: string;
        name: string;
        phone: string;
