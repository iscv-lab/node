...
import type { IIGController, IIGControllerInterface } from '../../../../controller/business/iig/IIGController';
...
type IIGControllerConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (xs: IIGControllerConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
  xs.length > 1;
...
export class IIGController__factory extends ContractFactory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): IIGController {
